...
void GoQuicSimpleServerStreamOnInitialHeadersComplete_C(void* go_quic_spdy_client_stream, const char *data, uint32_t data_len);
void GoQuicSimpleServerStreamOnTrailingHeadersComplete_C(void* go_quic_spdy_client_stream, const char *data, uint32_t data_len);
