...
void* CreateIncomingDynamicStream_C(void* go_quic_server_session, uint32_t id, void* go_quic_simple_server_stream_go_wrapper) {
...
void GoQuicSimpleServerStreamOnInitialHeadersComplete_C(void* go_quic_simple_server_stream, const char *data, uint32_t data_len) {
    GoQuicSimpleServerStreamOnInitialHeadersComplete(go_quic_simple_server_stream, (void *)data, data_len);
}
void GoQuicSimpleServerStreamOnTrailingHeadersComplete_C(void* go_quic_simple_server_stream, const char *data, uint32_t data_len) { GoQuicSimpleServerStreamOnTrailingHeadersComplete(go_quic_simple_server_stream, (void *)data, data_len);
}
void GoQuicSimpleServerStreamOnDataAvailable_C(void* go_quic_simple_server_stream, const char *data, uint32_t data_len, int is_closed) {
    GoQuicSimpleServerStreamOnDataAvailable(go_quic_simple_server_stream, (void *)data, data_len, is_closed);
}

void GoQuicSimpleServerStreamOnClose_C(void* go_quic_simple_server_stream) {
