...
func DebugInfo(b *bytes.Buffer) {
	b.WriteString(fmt.Sprintln("ProofSource - ", len(proofSourcePtr.pool)))
	b.WriteString(fmt.Sprintln("ProofVerifier - ", len(proofVerifierPtr.pool)))
	b.WriteString(fmt.Sprintln("ProofVerifyJob - ", len(proofVerifyJobPtr.pool)))
	b.WriteString(fmt.Sprintln("TaskRunner - ", len(taskRunnerPtr.pool)))
	b.WriteString(fmt.Sprintln("ServerWriter - ", len(serverWriterPtr.pool)))
	b.WriteString(fmt.Sprintln("ClientWriter - ", len(clientWriterPtr.pool)))
	b.WriteString(fmt.Sprintln("QuicDispatcher - ", len(quicDispatcherPtr.pool)))
	b.WriteString(fmt.Sprintln("QuicServerSession - ", len(quicServerSessionPtr.pool)))
	b.WriteString(fmt.Sprintln("GoQuicAlarm - ", len(goQuicAlarmPtr.pool)))
	b.WriteString(fmt.Sprintln("QuicServerStream - ", len(quicServerStreamPtr.pool)))
	b.WriteString(fmt.Sprintln("QuicClientStream - ", len(quicClientStreamPtr.pool)))
}